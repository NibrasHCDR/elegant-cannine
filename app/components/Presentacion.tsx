    ...
    <div className="w-screen h-auto pt-24 bg-img2 bg-cover">
        ...
        <div className="grid-Presentacion-container justify-center">
          <div className="Presentacion-1 text-center space-y-4">
             <h1 className="lg:text-5xl text-2xl font-philosopher no-select">Nuestros Servicios</h1>
             <h2 className="lg:text-2xl text-lg font-oreglega no-select">Explora un mundo de cuidado y diversión para tu mascota. <br></br> Nuestros servicios harán sonreír a tu mejor amigo de cuatro patas</h2>
          </div>
          ...
          <div className="Presentacion-2 text-center justify-center items-center m-4 space-y-1">
            ...
            <Image 
                      className="cursor-default filter h-[250px] w-[250px] lg:pt-32 xl:pt-0" alt="Descripción de la imagen"
                      layout='intrinsic'
                      objectFit="cover"
                     src={myImage} 
             />  
            ...
            <button className="w-14 h-14 border-4 no-select border-[#34B1BF] rounded-full text-[#34B1BF] transition-all duration-300 hover:scale-110 lg:text-3xl font-oreglega hover:text-[#F8D571] hover:border-[#F8D571]">1</button>
          </div>
          ...
          <div className="h-auto w-auto flex text-center justify-center items-center">
            ...
            <button className="w-14 h-14 border-4 no-select border-[#34B1BF] rounded-full text-[#34B1BF] transition-all duration-300 hover:scale-110 lg:text-3xl font-oreglega hover:text-[#F8D571] hover:border-[#F8D571]">2</button>
          ...
          <div className="h-auto w-auto flex text-center justify-center items-center ">
            ...
            <button className="w-14 h-14 border-4 no-select border-[#34B1BF] rounded-full text-[#34B1BF] transition-all duration-300 hover:scale-110 lg:text-3xl font-oreglega hover:text-[#F8D571] hover:border-[#F8D571]">3</button>
